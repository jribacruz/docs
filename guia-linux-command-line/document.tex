...
\subsection{Configurando proxy}
	...
	\paragraph{\fbox{\texttt{proxy=\emph{IP}}}} \emph{Fedora}

	\paragraph{\fbox{\texttt{Acquire::http::Proxy "http://\emph{IP}:\emph{PORTA}";}}} \emph{Debian/Ubuntu}
...
\subsection{Alterando proprietário de arquivos e diretórios}
	...
	\paragraph{\fbox{\texttt{\$ chown \emph{USER}:\emph{GROUP} \emph{/DIR/ARQ.xxx}}}}
	
	\paragraph{\fbox{\texttt{\$ chown -R \emph{USER}:\emph{GROUP} \emph{/DIR}}}} \emph{Em todos arquivos do diretório.}
...
\subsection{Alterando permissões de arquivos e diretórios}
	...
	\paragraph{\fbox{\texttt{\$ chmod -R 755 \emph{/DIR/}}}} \emph{Em todos arquivos do diretório.}
...
\subsection{Exibindo conteúdo de arquivo}
	...
	\paragraph{\fbox{\texttt{\$ cat \emph{/DIR/ARQ.xxx}}}}
	
	\paragraph{\fbox{\texttt{\$ cat \emph{/DIR/ARQ.xxx} | more}}} \emph{Com paginação.}
	
	\paragraph{\fbox{\texttt{\$ tail -n 100 \emph{/DIR/ARQ.xxx}}}} \emph{100 últimas linhas.}
	
	\paragraph{\fbox{\texttt{\$ tail -f \emph{/DIR/ARQ.xxx}}}} \emph{Exibição em tempo real.}
...
\subsection{Descompactando arquivos (tar)}
	...
	\fbox{\texttt{\$ tar -xvf \emph{ARQUIVO.tar}}} \emph{Descompacta no diretório atual.}
%%
\section{Processos}
\subsection{Listando processos}
	...
	\paragraph{\fbox{\texttt{\$ ps -aux | grep \emph{NAME} }}} \emph{Filtrando saída.} 
...
\subsection{Realizando requisição HTTP}
	...
	\paragraph{\fbox{\texttt{\$ curl http://ENDERECO-WEB/ }}} \emph{GET} 
	
	\paragraph{\fbox{\texttt{\$ curl http://ENDERECO-WEB/ -X POST }}} \emph{POST} 
